...
namespace Utils.EntityFramework
{
    public static class ExpressionExtension
    {
        ...
        public static MemberInfo GetMemberInfo<TEntity, TMember>(this Expression<Func<TEntity, TMember>> expression)
        {
            ...
            {
                throw new ArgumentException(string.Format("propertyExpression_must_be_lambda_expression", nameof(expression)), nameof(expression));
            }
            ...
            {
                throw new ArgumentException(string.Format("propertyExpression_must_be_lambda_expression", nameof(memberExpression)), nameof(memberExpression));
            }
